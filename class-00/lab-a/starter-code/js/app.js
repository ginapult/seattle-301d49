...
function displayPics() {
  ...
  // The previous line threw an error when changed from var to const because const when declared within a code block is local, not global, so it comes back as rando is undefined.
  console.log(viewed);
